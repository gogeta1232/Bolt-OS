...
> Check order is `src/lib/utils/moderation-permission-checker.ts:1` and every action rechecks `target.member.bannable` at execution. Full reference → [Bolt docs — permissions](https://bolt-docs-gogeta1232s-projects.vercel.app/guides/fake-permissions)
...
<a href="https://bolt-docs-gogeta1232s-projects.vercel.app"><img alt="Docs" src="https://img.shields.io/badge/Docs-bolt--docs.vercel.app-ff482c?style=for-the-badge" /></a>
</p>
...
Full guide: [bolt-docs.vercel.app/guides/fake-permissions](https://bolt-docs-gogeta1232s-projects.vercel.app/guides/fake-permissions) — source `site/src/content/fake-permissions.md`
...
For slash, keep `applications.commands`. Enable the intents you use. Docs: [bolt-docs.vercel.app](https://bolt-docs-gogeta1232s-projects.vercel.app) · [Invite guide](https://bolt-docs-gogeta1232s-projects.vercel.app/guides/invite-permissions)
